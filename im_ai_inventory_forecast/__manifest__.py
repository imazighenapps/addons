...
- Multi-warehouse support
    ...
    'assets': {
        'web.assets_backend': [
            'im_ai_inventory_forecast/static/src/css/forecast_dashboard.css',
            'im_ai_inventory_forecast/static/src/js/forecast_dashboard.js',
            'im_ai_inventory_forecast/static/src/xml/forecast_dashboard.xml',
        ],
    },
